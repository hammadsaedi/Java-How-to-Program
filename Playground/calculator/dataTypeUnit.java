...
public class dataTypeUnit {
    ...
    public static String toParsableDECString(String number, String type, int radix){
        // try to parse in given data type and again convert into String
        try {
            // converting string of radix to decimal number system  
            number = numberSystemUnit.toDEC(number, radix);

            // Checking parse-ability
            if (type.equals("Byte")){
